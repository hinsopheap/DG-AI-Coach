...
export default function NotFound() {
  return (
    <>
      <Head>
        <title>Page not found · DG AI Coach</title>
      ...
      <div style={s.page}>
        ...
        <div style={s.card}>
          ...
          <h1 style={s.h1}>That page isn't here.</h1>
          <p style={s.lede}>It might have moved, or the link was off. Pick a real surface below.</p>
          <div style={s.row}>
            <Link href="/chat" style={s.primary}>Open chat</Link>
            <Link href="/dashboard" style={s.secondary}>Dashboard</Link>
...
const s = {
  ...
  code:       { fontSize: 64, fontWeight: 700, color: '#C96442', letterSpacing: -2, lineHeight: 1 },
